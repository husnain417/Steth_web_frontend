...
export default function OrderSummary({ onDiscountCodeChange, onRemoveProduct, onDiscountUpdate, deliveryInfo }) {
  ...
  // SHIPPING RATES - Add your actual shipping rates here
  const shippingRates = {
    'Pakistan': 200,
    'India': 500,
    'UAE': 800,
  ...
  // FIXED: Calculate shipping charges based on country and total
  ...
  // Get country display name for shipping info
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="border-t border-gray-200 pt-4">
        ...
        {/* Shipping section with enhanced info */}
        <div className="flex justify-between mb-2">
          <div className="flex items-center">
            <span>Shipping</span>
            <div className="relative group ml-2">
