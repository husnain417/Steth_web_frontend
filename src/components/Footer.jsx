        ...
        <div className="flex flex-col md:flex-row space-y-8 md:space-y-0">
          ...
          <div className="w-full md:w-3/4 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <li><Link to="/aboutus#contact" className="text-gray-400 hover:text-white">Contact Us</Link></li>
              <li><a href="mailto:info@steth.com" className="text-gray-400 hover:text-white">info@steth.com</a></li>
              <li><a href="tel:+923390001306" className="text-gray-400 hover:text-white">+92 3390001306</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/students" className="text-gray-400 hover:text-white">Student Discount</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/terms" className="text-gray-400 hover:text-white">STETH Terms & Conditions</Link></li>
              </ul>
            </div>
          </div>
        </div>
